...
<body>
    ...
    <form action="{{ route('produto.update', $produto->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid w-full">
            ...
            <select class="file-input file-input-bordered w-full" placeholder="" name="afiliado"></select>
        </div>
        <div class="grid w-full">
            <label for="produtor">Produto do produto</label>
            <select class="file-input file-input-bordered w-full" placeholder="" name="produtor"></select>
        </div>
